...
The resulting block model will have it's core region set by the object and limited in its depth extent.
The core region will contain cells at the requested cell size.  Padding will be applied outward from the
