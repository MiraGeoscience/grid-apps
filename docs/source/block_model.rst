...
An Block Model grid is a discretization of a 3D volume into a set of rectangular cells. The core region is defined by both the input ``Object`` with a depth limiter provided by the
