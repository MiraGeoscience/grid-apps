...
Whether you are a developer or an end-user, this page will help you get started with the **grid-apps**.
...
Follow this link to `download from the GitHub repository <https://github.com/MiraGeoscience/grid-apps/archive/refs/heads/main.zip>`_.
